...
endif(ALTANAL_ENABLE_WARNING)

if (ALTANAL_ENABLE_COVERAGE)
  ...
  if(CMAKE_C_COMPILER_ID MATCHES GNU)
    ...
    message(FATAL_ERROR "Code coverage is only available with the GNU C (gcc)"
      "\n   compiler, please turn ALTANAL_ENABLE_COVERAGE OFF\n.")
  endif()
  ...
  if(CMAKE_CXX_COMPILER_ID MATCHES GNU)
    ...
    message(FATAL_ERROR "Code coverage is only available with the GNU CXX"
      "\n   (g++) compiler, please turn ALTANAL_ENABLE_COVERAGE OFF\n.")
  endif()
  ...
  if(CMAKE_Fortran_COMPILER_ID MATCHES GNU)
    ...
    message(FATAL_ERROR "Code coverage is only available with the GNU"
      "\n   Fortran (gfortran) compiler, please turn ALTANAL_ENABLE_COVERAGE"
      "\n   OFF\n.")
  endif()

  set(CMAKE_EXE_LINKER_FLAGS "${CMAKE_EXE_LINKER_FLAGS} --coverage")

endif(ALTANAL_ENABLE_COVERAGE)
