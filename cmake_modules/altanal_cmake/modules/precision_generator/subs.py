...
subs = {
  ...
  'mixed' : [
    ...
    ('real',                      'complex'                          ),
    ('float',                     'ALTANAL_Complex32_t'                ),
    ('double',                    'ALTANAL_Complex64_t'                ),
    ('float',                     'ALTANAL_voidComplex32_t'            ),
    ('double',                    'ALTANAL_voidComplex64_t'            ),
    ('AltanalRealFloat',            'AltanalComplexFloat'                ),
    ('AltanalRealDouble',           'AltanalComplexDouble'               ),
    ...
    ('ALTANAL_D',                   'ALTANAL_Z'                          ),
    ('ALTANAL_S',                   'ALTANAL_C'                          ),
    ('altanal_get_d',               'altanal_get_z'                      ),
    ('altanal_get_s',               'altanal_get_c'                      ),
    ('TASK_S',                    'TASK_C'                           ),
    ('TASK_D',                    'TASK_Z'                           ),
    ('TASKS_S',                   'TASKS_C'                          ),
    ('TASKS_D',                   'TASKS_Z'                          ),
    ('ALTANAL_Runtime_S',                 'ALTANAL_Runtime_C'                        ),
    ('ALTANAL_Runtime_D',                 'ALTANAL_Runtime_Z'                        ),
    ...
    # ----- ALTANAL
    ('altanal_sdgetrs',             'altanal_czgetrs'                    ),

    # ----- Constants
    ('CblasTrans',                'CblasConjTrans'                   ),
    ('MagmaTrans',                'MagmaConjTrans'                   ),
    ('AltanalTrans',                'AltanalConjTrans'                   ),
  ...
  'normal' : [
    ...
    # ALTANAL
    ('', 'float',                'double',                'ALTANAL_Complex32_t',               r'\bALTANAL_Complex64_t'                ),
    ('', 'float',                'double',                'ALTANAL_voidComplex32_t',           r'\bALTANAL_voidComplex64_t'            ),
    ('', 'AltanalRealFloat',       'AltanalRealDouble',       'AltanalComplexFloat',               r'\bAltanalComplexDouble'               ),
    # Pastix
    ...
    # ----- Prefixes ALTANAL
    ('', 'ALTANAL_S',        'ALTANAL_D',        'ALTANAL_C',        'ALTANAL_Z'         ),
    ('', 'ALTANAL_sor',      'ALTANAL_dor',      'ALTANAL_cun',      'ALTANAL_zun'       ),
    ('', 'ALTANAL_s',        'ALTANAL_d',        'ALTANAL_c',        'ALTANAL_z'         ),
    ('', 'altanal_get_s',    'altanal_get_d',    'altanal_get_c',    'altanal_get_z'     ),
    ('', 'altanal_ps',       'altanal_pd',       'altanal_pc',       'altanal_pz'        ),
    ('', 'altanal_s',        'altanal_d',        'altanal_c',        'altanal_z'         ),
    ('', 'altanal_sdesc',    'altanal_ddesc',    'altanal_sdesc',    'altanal_ddesc'     ),
    ...
    ('', 'ALTANAL_Runtime_S',      'ALTANAL_Runtime_D',      'ALTANAL_Runtime_C',      'ALTANAL_Runtime_Z'       ),
    ('', 'ALTANAL_Runtime_s',      'ALTANAL_Runtime_d',      'ALTANAL_Runtime_c',      'ALTANAL_Runtime_z'       ),
    ...
    ('AltanalTrans',  'AltanalTrans',  'AltanalTrans',  'AltanalConjTrans',  r'\bAltanalConjTrans'  ),
...
# ADD FOR NEW VERSION OF ALTANAL
