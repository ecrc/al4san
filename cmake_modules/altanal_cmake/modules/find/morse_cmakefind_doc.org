#+TITLE: ALTANAL CMake "Find modules" documentation
#+AUTHOR: HiePACS
#+LANGUAGE:  en
...
This document aims at documenting ALTANAL find_package CMake modules
...
To use ALTANAL modules you should call the *AltanalInit* module as follows:
#+BEGIN_EXAMPLE
# For example if Altanal CMake modules are located in ./cmake_modules/altanal_cmake
# append this directory to the list of directories containing CMake modules
list(APPEND CMAKE_MODULE_PATH "${CMAKE_SOURCE_DIR}/cmake_modules/altanal_cmake/modules" )
