...
subs = {
  ...
  'mixed' : [
    ...
    ('real',                      'complex'                          ),
    ('float',                     'AL4SAN_Complex32_t'                ),
    ('double',                    'AL4SAN_Complex64_t'                ),
    ('float',                     'AL4SAN_voidComplex32_t'            ),
    ('double',                    'AL4SAN_voidComplex64_t'            ),
    ('Al4sanRealFloat',            'Al4sanComplexFloat'                ),
    ('Al4sanRealDouble',           'Al4sanComplexDouble'               ),
    ...
    ('AL4SAN_D',                   'AL4SAN_Z'                          ),
    ('AL4SAN_S',                   'AL4SAN_C'                          ),
    ('al4san_get_d',               'al4san_get_z'                      ),
    ('al4san_get_s',               'al4san_get_c'                      ),
    ('TASK_S',                    'TASK_C'                           ),
    ('TASK_D',                    'TASK_Z'                           ),
    ('TASKS_S',                   'TASKS_C'                          ),
    ('TASKS_D',                   'TASKS_Z'                          ),
    ('AL4SAN_Runtime_S',                 'AL4SAN_Runtime_C'                        ),
    ('AL4SAN_Runtime_D',                 'AL4SAN_Runtime_Z'                        ),
    ...
    # ----- AL4SAN
    ('al4san_sdgetrs',             'al4san_czgetrs'                    ),

    # ----- Constants
    ('CblasTrans',                'CblasConjTrans'                   ),
    ('MagmaTrans',                'MagmaConjTrans'                   ),
    ('Al4sanTrans',                'Al4sanConjTrans'                   ),
  ...
  'normal' : [
    ...
    # AL4SAN
    ('', 'float',                'double',                'AL4SAN_Complex32_t',               r'\bAL4SAN_Complex64_t'                ),
    ('', 'float',                'double',                'AL4SAN_voidComplex32_t',           r'\bAL4SAN_voidComplex64_t'            ),
    ('', 'Al4sanRealFloat',       'Al4sanRealDouble',       'Al4sanComplexFloat',               r'\bAl4sanComplexDouble'               ),
    # Pastix
    ...
    # ----- Prefixes AL4SAN
    ('', 'AL4SAN_S',        'AL4SAN_D',        'AL4SAN_C',        'AL4SAN_Z'         ),
    ('', 'AL4SAN_sor',      'AL4SAN_dor',      'AL4SAN_cun',      'AL4SAN_zun'       ),
    ('', 'AL4SAN_s',        'AL4SAN_d',        'AL4SAN_c',        'AL4SAN_z'         ),
    ('', 'al4san_get_s',    'al4san_get_d',    'al4san_get_c',    'al4san_get_z'     ),
    ('', 'al4san_ps',       'al4san_pd',       'al4san_pc',       'al4san_pz'        ),
    ('', 'al4san_s',        'al4san_d',        'al4san_c',        'al4san_z'         ),
    ('', 'al4san_sdesc',    'al4san_ddesc',    'al4san_sdesc',    'al4san_ddesc'     ),
    ...
    ('', 'AL4SAN_Runtime_S',      'AL4SAN_Runtime_D',      'AL4SAN_Runtime_C',      'AL4SAN_Runtime_Z'       ),
    ('', 'AL4SAN_Runtime_s',      'AL4SAN_Runtime_d',      'AL4SAN_Runtime_c',      'AL4SAN_Runtime_z'       ),
    ...
    ('', 'al4san_ssqrt',    'al4san_dsqrt',    'al4san_ssqrt',    'al4san_dsqrt'     ),
    ...
    ('Al4sanTrans',  'Al4sanTrans',  'Al4sanTrans',  'Al4sanConjTrans',  r'\bAl4sanConjTrans'  ),
