#+TITLE: AL4SAN CMake "Find modules" documentation
#+AUTHOR: HiePACS
#+LANGUAGE:  en
...
This document aims at documenting AL4SAN find_package CMake modules
...
To use AL4SAN modules you should call the *Al4sanInit* module as follows:
#+BEGIN_EXAMPLE
# For example if Al4san CMake modules are located in ./cmake_modules/al4san_cmake
