...
AL4SAN_TASK_CPU(latro1, latro_cpu_func1)

void EIG_AL4SAN_CORE_dlatro1(AL4SAN_option_t *options,
                       ...
                       const AL4SAN_desc_t *B, int Bm, int Bn, int ldb)
{
    ...
    AL4SAN_Insert_Task(AL4SAN_TASK(latro1), (AL4SAN_option_t*)options,
...
void latro_cpu_func1(AL4SAN_arg_list *al4san_arg)
{
    int uplo;
    int trans;
    int M;
