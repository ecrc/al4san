...
void AL4SAN_Starpu_context_create( AL4SAN_context_t *al4san )
{
    starpu_conf_t *conf;
 ...
 *  Clean the context
 */
void AL4SAN_Starpu_context_destroy( AL4SAN_context_t *al4san )
{
 ...
 *
 */
void AL4SAN_Starpu_enable( AL4SAN_enum lever )
{
    switch (lever)
    {
 ...
 *
 */
void AL4SAN_Starpu_disable( AL4SAN_enum lever )
{
    switch (lever)
    {
        case AL4SAN_PROFILING_MODE:
