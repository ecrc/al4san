 ...
 *  Create a sequence
 */
int AL4SAN_Starpu_sequence_create( AL4SAN_context_t  *al4san,
 ...
 *  Destroy a sequence
 */
int AL4SAN_Starpu_sequence_destroy( AL4SAN_context_t  *al4san,
                              AL4SAN_sequence_t *sequence )
{
    (void)al4san;
    (void)sequence;
 ...
 */
int AL4SAN_Starpu_sequence_wait( AL4SAN_context_t  *al4san,
                           AL4SAN_sequence_t *sequence )
{
    (void)al4san;
    (void)sequence;
 ...
 */
void AL4SAN_Starpu_sequence_flush( AL4SAN_context_t *al4san,
                             AL4SAN_sequence_t *sequence,
