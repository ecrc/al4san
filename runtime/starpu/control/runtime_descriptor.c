...
#if defined(AL4SAN_USE_MPI)
    int rc;
    rc = al4san_runtime_tag_init( user_tag_width, user_tag_sep );
...
void AL4SAN_RUNTIME_malloc( void**ptr, size_t size )
{
...
void AL4SAN_Runtime_desc_create( AL4SAN_desc_t *desc )
{
     ...
     */
    {
        al4san_runtime_tag_init( tag_width, tag_sep );
...
void AL4SAN_Runtime_desc_flush( const AL4SAN_desc_t     *desc,
...
void AL4SAN_Runtime_data_flush( const AL4SAN_sequence_t *sequence,
...
void AL4SAN_Runtime_matrix_flush( const AL4SAN_sequence_t *sequence,
                         const AL4SAN_desc_t *A, int m, int n )
{
    int64_t mm = m + (A->i / A->mb);
    int64_t nn = n + (A->j / A->nb);
...
void AL4SAN_Runtime_vector_flush( const AL4SAN_sequence_t *sequence,
...
void AL4SAN_Runtime_scaler_flush( const AL4SAN_sequence_t *sequence,
                           ...
                           const AL4SAN_desc_t *A, int Am, int An, int new_rank )
{
    ...
    if ( lhandle == NULL ) {
        /* Register the data */
        lhandle = AL4SAN_Runtime_data_getaddr( A, Am, An );
    }
                           ...
                           const AL4SAN_desc_t *A, int Am, int new_rank )
{
    ...
    if ( lhandle == NULL ) {
        /* Register the data */
        lhandle = AL4SAN_Runtime_data_getaddr( A, Am, 0 );
    }
                           ...
                           const AL4SAN_desc_t *A, int new_rank )
{
    ...
    if ( lhandle == NULL ) {
        /* Register the data */
        lhandle = AL4SAN_Runtime_data_getaddr( A, 0, 0 );
    }
...
void *AL4SAN_Runtime_data_getaddr( const AL4SAN_desc_t *A, int m, int n )
{
    int64_t mm = m + (A->i / A->mb);
    int64_t nn = n + (A->j / A->nb);
...
void *AL4SAN_Runtime_matrix_getaddr( const AL4SAN_desc_t *A, int m, int n )
{
    int64_t mm = m + (A->i / A->mb);
    int64_t nn = n + (A->j / A->nb);
...
void *AL4SAN_Runtime_vector_getaddr( const AL4SAN_desc_t *A, int m )
{
    int64_t mm = m + (A->i / A->mb);
    int64_t nn = 0 + (A->j / A->nb);
...
void *AL4SAN_Runtime_scaler_getaddr( const AL4SAN_desc_t *A)
{
    int64_t mm = 0 + (A->i / A->mb);
    int64_t nn = 0 + (A->j / A->nb);
...
void AL4SAN_RUNTIME_data_getaddr( const AL4SAN_desc_t *A, void **ptr, int m, int n )
{
    int64_t mm = m + (A->i / A->mb);
    int64_t nn = n + (A->j / A->nb);
