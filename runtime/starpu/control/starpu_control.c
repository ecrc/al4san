...
int AL4SAN_Starpu_init( AL4SAN_context_t *al4san,
                  int ncpus,
                  int ncudas,
 ...
 *
 */
void AL4SAN_Starpu_finalize( AL4SAN_context_t *al4san )
{
    (void)al4san;
 ...
 */
void AL4SAN_Starpu_pause( AL4SAN_context_t *al4san )
{
    (void)al4san;
    starpu_pause();
    return;
...
/**
 *  This is the symmetrical call to AL4SAN_Starpu_pause,
 *  used to resume the workers polling for new tasks.
 */
void AL4SAN_Starpu_resume( AL4SAN_context_t *al4san )
{
    (void)al4san;
    starpu_resume();
    return;
 ...
 */
void AL4SAN_Starpu_barrier( AL4SAN_context_t *al4san )
{
    (void)al4san;
 ...
 */
void AL4SAN_Starpu_progress( AL4SAN_context_t *al4san )
{
 ...
 * Thread rank.
 */
int AL4SAN_Starpu_thread_rank( AL4SAN_context_t *al4san )
{
    (void)al4san;
 ...
 * Number of threads.
 */
int AL4SAN_Starpu_thread_size( AL4SAN_context_t *al4san )
{
    (void)al4san;
 ...
 *  The process rank
 */
int AL4SAN_Starpu_comm_rank( AL4SAN_context_t *al4san )
{
    int rank = 0;
 ...
 */
int AL4SAN_Starpu_comm_size( AL4SAN_context_t *al4san )
{
    int size;
#if defined(AL4SAN_USE_MPI)
#  if defined(HAVE_STARPU_MPI_COMM_RANK)
