 ...
 ***
 *
 * @brief Altanal StarPU codelet profiling header
 *
 * @version 1.0.0
 ...
 *
 */
#ifndef __CODELET_PROFILING_H__
#define __CODELET_PROFILING_H__

#include <math.h>

#define ALTANAL_CL_CB(name, _m, _n, _k, _nflops)			\
