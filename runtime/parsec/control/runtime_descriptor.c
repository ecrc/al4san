...
void AL4SAN_Runtime_free( void *ptr, size_t size )
{
    (void)size;
    free(ptr);
    return;
 ...
 */
void AL4SAN_Runtime_desc_create( AL4SAN_desc_t *mdesc )
{
    ...
    /* Super setup */
    comm_size = AL4SAN_Runtime_comm_size( NULL );
 ...
 */
void AL4SAN_Runtime_desc_destroy( AL4SAN_desc_t *mdesc )
{
