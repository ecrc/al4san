 ...
 *  Create new context
 **/
void AL4SAN_Openmp_context_create(AL4SAN_context_t *al4san)
{
...
void AL4SAN_Openmp_context_destroy(AL4SAN_context_t *al4san)
{
    (void)al4san;
    return;
}
 ...
 *
 */
void AL4SAN_Openmp_enable(AL4SAN_enum lever)
{
    switch (lever)
    {
 ...
 *
 **/
void AL4SAN_Openmp_disable(AL4SAN_enum lever)
{
    switch (lever)
    {
        case AL4SAN_PROFILING_MODE:
