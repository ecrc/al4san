...
int
al4san_quark_tag_init( int user_tag_width,
                           int user_tag_sep )
{
   (void)user_tag_width;
   (void)user_tag_sep;
...
void AL4SAN_Quark_comm_set_tag_sizes( int user_tag_width,
                                 int user_tag_sep )
{
    (void)user_tag_width;
    (void)user_tag_sep;
...
void AL4SAN_Quark_malloc_ptr(void**A, size_t size )
{ 
   *A = malloc( size );
}

void *AL4SAN_Quark_malloc( size_t size )
{ 
   return malloc(size);
}

void AL4SAN_Quark_free( void  *ptr,
                   size_t size )
{
    (void)size;
    free( ptr );
...
void AL4SAN_Quark_desc_create( AL4SAN_desc_t *desc )
{
    (void)desc;
    return;
}

void AL4SAN_Quark_desc_destroy( AL4SAN_desc_t *desc )
{
    (void)desc;
    return;
}

int AL4SAN_Quark_desc_acquire( const AL4SAN_desc_t *desc )
{
    (void)desc;
    return AL4SAN_SUCCESS;
}

int AL4SAN_Quark_desc_release( const AL4SAN_desc_t *desc )
{
    (void)desc;
    return AL4SAN_SUCCESS;
}
...
void AL4SAN_Quark_data_migrate( const AL4SAN_sequence_t *sequence,
                           const AL4SAN_desc_t *A, int Am, int An, int new_rank )
{
    (void)sequence; (void)A; (void)Am; (void)An; (void)new_rank;
}

void AL4SAN_Quark_matrix_migrate( const AL4SAN_sequence_t *sequence,
                           const AL4SAN_desc_t *A, int Am, int An, int new_rank )
{
    (void)sequence; (void)A; (void)Am; (void)An; (void)new_rank;
}

void AL4SAN_Quark_vector_migrate( const AL4SAN_sequence_t *sequence,
                           const AL4SAN_desc_t *A, int Am, int new_rank )
{
    (void)sequence; (void)A; (void)Am; (void)new_rank;
}

void AL4SAN_Quark_scaler_migrate( const AL4SAN_sequence_t *sequence,
...
/*void *AL4SAN_Quark_data_getaddr( const AL4SAN_desc_t *desc, int m, int n)
{
...
void *AL4SAN_Quark_matrix_getaddr( const AL4SAN_desc_t *desc, int m, int n)
{
  return desc->get_blkaddr( desc, m, n );
}

void *AL4SAN_Quark_vector_getaddr( const AL4SAN_desc_t *desc, int m)
{
  return desc->get_blkaddr( desc, m, 0 );
}
void *AL4SAN_Quark_scaler_getaddr( const AL4SAN_desc_t *desc)
{
...
int AL4SAN_Quark_data_getrank( const AL4SAN_desc_t *A, int m, int n )
{
...
int AL4SAN_Quark_matrix_getrank( const AL4SAN_desc_t *A, int m, int n )
{

  return A->get_rankof( A, m, n );
}

int AL4SAN_Quark_vector_getrank( const AL4SAN_desc_t *A, int m)
{

  return A->get_rankof( A, m, 0);
}

int AL4SAN_Quark_scaler_getrank( const AL4SAN_desc_t *A)
{
...
void AL4SAN_Quark_broadcast(AL4SAN_sequence_t *sequence, int myrank,
  ...
  //fprintf(stderr, "It is not available in QUARK since it is shared-memory only\n");
  return;
}
